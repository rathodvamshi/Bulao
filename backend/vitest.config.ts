...
export default defineConfig({ test: {
  include: ["tests/domain.test.ts", "tests/providers.test.ts", "tests/storage.test.ts", "tests/auth-policy.test.ts", "tests/auth-*.unit.test.ts", "tests/notifications.unit.test.ts"],
